...
namespace Scryber.OpenType.Woff2.Numerics
{
    ...
    /// <remarks>Copied directly from the dotnet source to support net standard 2.0</remarks>
    public partial struct Vector2 : IEquatable<Vector2>, IFormattable
    {
        ...
        /*
         * 
         * Removed the support for the matrix transformations as not needed in the Woof2 support
         * 
         */
        ...
        {
            return (int)Math.Min((X * Y), (double)int.MaxValue);
        }
